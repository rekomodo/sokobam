...
const reducersSchema = __reducers(
  __reducerSchema("claim_winner", ClaimWinnerReducer),
  __reducerSchema("deregister_game_code", DeregisterGameCodeReducer),
  __reducerSchema("join_game", JoinGameReducer),
  __reducerSchema("register_game_code", RegisterGameCodeReducer),
